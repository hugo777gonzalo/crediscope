...
export const FRAMEWORK_VERSION = "framework-v1";
...
lista negra (guardrailHallazgos, aparte del profile). Si alguno de esos
"guardrails" está activo, igual redacta tu análisis normalmente (explica
lo que ves), pero asume que el score final lo va a forzar el sistema a 1
sin importar tu número — no te preocupes por eso.
...
4. compliance — ya son guardrails resueltos aparte (enListaControl,
   enListaNegra, impedimentoCargosPublicos fuerzan el score si true).
